...
operation::query-events[snippets='response-fields,curl-request,http-response,links']
...
operation::get-an-event[snippets='request-fields,curl-request,http-response,links']
